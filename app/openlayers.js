...
const investmentTips = {
    ...
    Africa: "Les leaders actuels sont le Soudan, le Congo et la République Démocratique du Congo, où les surfaces agricoles investies affichent des taux exceptionnels. L’Éthiopie est en train de devenir un terrain de jeu stratégique, avec un nombre de deals qui explose ces dernières années. Depuis 2020, le Nord de l’Afrique attire de plus en plus l’attention des investisseurs – opportunité à long terme pour les plantations résilientes au climat et les projets à impact social.", 
    Asia: "L’Indonésie domine le marché avec plus de 150 000 hectares investis sur 10 ans, un véritable eldorado pour les investisseurs en huile de palme et autres cultures tropicales. Le Cambodge voit également son nombre de deals augmenter, signe d’une émergence à surveiller. La Chine reste sélective : peu de deals mais très vastes en superficie – un jeu à haut risque mais potentiellement très rentable. Restez attentifs aux régulations locales, elles peuvent faire ou défaire vos marges.",
